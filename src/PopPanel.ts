 ...
 *
 */
class PopPanel extends egret.Sprite{
    
    public gameoverPanel: egret.Sprite;
    private bg: egret.Sprite;
    private btn: egret.Sprite;
    private text: egret.TextField;
    
    private static instance: PopPanel;
	public constructor() {
        super();
	}
    private init(): void { 
    ...
    //初始化
    private initGameoverPanel(): void {
        //提示性文本
...
//单例
    public static getInstance(): PopPanel { 
